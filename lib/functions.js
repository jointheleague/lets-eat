...
getInfoWindow = function(marker) {
  ...
  return new google.maps.InfoWindow({
    ...
    '<span class="infowindow" style="vertical-align: top"><small><b>Foods:</b> ' + parseFoods(marker.foods) + '</small><br>' +'<small><b>Hours:</b> ' + marker.hours + '</small>' + urlInfo + '<br><small><b>Phone:</b> '+marker.phone+'</small><br><small><b>Closures:</b> '+marker.closures+'</small><br><small><b>Required Documents:</b> '+marker.documents+'</small><br><small><b>Eligibility:</b> '+(markers.eligibility ? markers.eligibility: 'none') +'</span>'+
      ...
      switch(foodType) {
        ...
        case "bread":
          ...
          break;
	        ...
	        break;
        case "government":
          a = "30 pound box of government canned and dry foods with a 5 pound block of cheese";
          break;
				case "boxed":
