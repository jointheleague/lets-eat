...
getInfoWindow = function(marker) {
  ...
  return new google.maps.InfoWindow({
    ...
    '<span class="infowindow" style="vertical-align: top"><small><b>Foods:</b> ' + marker.foods + '</small><br>' +'<small><b>Hours:</b> ' + marker.hours + '</small>' + urlInfo + '<br><small><b>Phone:</b> '+marker.phone+'</small><br><small><b>Closures:</b> '+marker.closures+'</small><br><small><b>Eligibility:</b> '+(markers.eligibility ? markers.eligibility: 'none') +'</span>'+
