...
getInfoWindow = function(marker) {
  ...
  if(marker.orgID) {
    if (marker.orgID.toUpperCase() === "SDFB") {
      ...
      currentImg='<img src="/SDFB.Color.Logo.PNG.png" style="width:100px;" /> <img src="/FASD.Logo.CMYK.jpg" style="width:100px;" />';
    }
  }
  ...
  return new google.maps.InfoWindow({
    content:
      '<div><h2 class="float: left">' + ((marker.url) && (marker.url !== "TBD") ? "<a href='" + document.url + "' target='_blank'>" + marker.name + "</a>" : marker.name) + '</h2>' +
      '<div class="float: right">' + currentImg + "</div></div><br>" +
      '<small>' + marker.foods + '</small><br>' +
