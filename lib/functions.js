...
getInfoWindow = function(marker) {
  ...
  return new google.maps.InfoWindow({
    content: // bad code, bad practice, bad person
      '<span class="infoWindowTitle infowindow">' + ((marker.url) && (marker.url !== "TBD") ? '<a href="' + document.url + '" target="_blank" class="infowindow"> ' + marker.name + '</a>' : marker.name) + '</span>' +
      '<span class="infowindow" style="float: right;">' + currentImg + "</span><br><br>" +
      '<span class="infowindow" style="vertical-align: top"><small>' + marker.foods + '</small><br>' +
