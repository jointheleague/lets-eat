...
getInfoWindow = function(marker) {
  ...
  return new google.maps.InfoWindow({
    ...
    '<span class="infowindow" style="vertical-align: top"><small>Foods: ' + marker.foods + '</small><br>' +'<small>Hours: ' + marker.hours + '</small>' + urlInfo + '<br><small>Phone: '+marker.phone+'</small><br><small>Closures: '+marker.closures+'</small><br><small>Reqired Documents: '+marker.documents+'</small><br><small>Eligibility: '+markers.eligibility+'</span>'+
